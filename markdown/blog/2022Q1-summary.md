...
An amazing success for [Alejandra Quetzalli](https://twitter.com/quetzalliwrites) and an excellent opportunity for the AsyncAPI Initiative to improve its documentation big time!
...
I wrote already about [Alejandra Quetzalli](https://twitter.com/quetzalliwrites) and the efforts to get AsyncAPI into GSoD. Getting a well-motivated group of people to work on docs, checked. :white_check_mark:
...
Huge applause to:
- [Alejandra Quetzalli](https://twitter.com/quetzalliwrites) for leading the change

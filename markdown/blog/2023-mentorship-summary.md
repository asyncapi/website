...
- **[Rewrite this template and NodeJS WS template](https://github.com/asyncapi/nodejs-template/issues/133)**: We overhauled the template by the program's success, transitioning from Nunjucks to the React template engine. Completing the switch modernizes our approach and designates React as the default engine moving forward, signaling a new era of template design.

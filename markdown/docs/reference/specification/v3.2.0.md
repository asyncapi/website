...
```json
{
  ...
  "traits": [
    { "$ref": "#/components/channelTraits/kafkaPublicEvents" }
  ]
}
```
...
<!-- asyncapi-example-tester:{"name":"Channel Trait Object","json_pointer":"/components/channelTraits/kafkaPublicEvents"} -->
```json
{
  "title": "Public events channel",
  "description": "Common traits for public event channels.",
  "tags": [
    { "name": "public" }
  ],
  "externalDocs": {
    "description": "Common channel policies",
    "url": "https://example.com/channel-policies"
  },
  "bindings": {
    "kafka": {
      "partitions": 10,

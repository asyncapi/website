...
import { type BuildMeetingsOptions, runBuildMeetings } from '../../npm/runners/build-meetings-runner';
...
describe('Integration: build-meetings-runner', () => {
  ...
  describe('Export and Type Safety', () => {
    it('should export the runBuildMeetings function', () => {
      ...
      expect(runBuildMeetings.constructor.name).toBe('AsyncFunction');
    });

    it('should export BuildMeetingsOptions interface', () => {
      const options: BuildMeetingsOptions = { outputPath: '/test/path.json' };
  ...
  describe('Error Handling', () => {
    ...
    it('should wrap errors in CustomError with context', async () => {
      ...
      await expect(runBuildMeetings({ outputPath: '/test/path.json' })).rejects.toThrow();
    });

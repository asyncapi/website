...
- All additional files for the case study, like complete AsyncAPI document examples, should be located in `public/resources/casestudies` directory.
...
A case study became publicly available right after merging and rebuilding the website.

  ...
  return (
    <footer className="bg-gray-900 mt-12 margin: 0 auto">
      <div className="max-w-screen-xl mx-auto py-10 px-4 overflow-hidden sm:px-6 lg:px-8 divide-y-2 divide-gray-700">
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="px-10 ml-5 mb-5">
              ...
              <ul className="justify-start" aria-label="AsyncAPI social media links">
                <li className="py-2">
                  <a href="https://twitter.com/AsyncAPISpec" target="_blank" rel="noopener noreferrer" className="text-gray-500 flex hover:text-blue-500">
                    <div className="">
                      <div className="flex fit-content items-center  hover:text-blue-500">
                        <span className="sr-only">Twitter</span>
                        <IconTwitter className="h-6 w-6" />
                        <span className="pl-2 text-gray-500">Twitter</span>
                      </div>
                    </div>
                  </a>
                </li>
                <li className="py-2">
                  <a href="https://github.com/asyncapi" target="_blank" rel="noopener noreferrer" className="text-gray-500 flex hover:text-gray-500">
                    <div className="">
                      <div className="flex fit-content items-center  hover:text-gray-600">
                        <span className="sr-only">GitHub</span>
                        <IconGithub className="h-6 w-6" />
                        <span className="pl-2 text-gray-500">GitHub</span>
                      </div>
                    </div>
                  </a>
                </li>
                  ...
                  <a href="https://linkedin.com/company/asyncapi" rel="noopener noreferrer" target="_blank" className="text-gray-500 flex hover:text-blue-500">
                    <div className="">
                      <div className="flex fit-content items-center hover:text-blue-500">
                        ...
                        <span className="pl-2 text-gray-500">LinkedIn</span>
                      </div>
                    </div>
                  </a>
                </li>
                  ...
                  <a href="https://youtube.com/asyncapi" target="_blank" rel="noopener noreferrer" className="text-gray-500 flex hover:text-red-600">
                    <div className="">
                      <div className="flex fit-content items-center  hover:text-red-600">
                        ...
                        <span className="pl-2 text-gray-500">YouTube</span>
                      </div>
                    </div>
                  </a>
                </li>
                  ...
                  <a href="https://asyncapi.com/slack-invite" target="_blank" rel="noopener noreferrer" className="text-gray-500">
                    <div className="">
                      <div className="flex fit-content items-center  hover:text-white">
                        ...
                        <span className="pl-2 text-gray-500">Slack</span>
                      </div>
                    </div>
                  </a>
                </li>
                  ...
                  <a href="https://www.twitch.tv/asyncapi" target="_blank" rel="noopener noreferrer" className="text-gray-500">
                    <div className="">
                      <div className="flex fit-content items-center hover:text-purple-500">
                        ...
                        <span className="pl-2 text-gray-500">Twitch</span>
                      </div>
                    </div>
                  </a>
                </li>
        ...
        <div className="flex justify-between items-center mt-20 px-5 py-10">
          <div className="px-2">

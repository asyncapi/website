  ...
  return (
    <div className="flex-col overflow-auto" data-testid="NewsroomBlog-main-div">
      ...
      <div className="flex flex-row ml-2 justify-content-center md:justify-content-start">
        ...
        <button ref={nextElRef} className={`${buttonClass} py-1 px-4 ${checkLastSnapIndex(current) ? 'cursor-not-allowed bg-white dark:bg-gray-400 border-gray-200 text-gray-200' : 'bg-secondary-100  hover:bg-secondary-500 border-secondary-500  text-secondary-500 hover:text-white'}`}  data-testid="Blog-Next-button">

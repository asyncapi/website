        ...
        <div className='flex flex-wrap items-center justify-between'>
          ...
          <div className='flex'>
            <a
              ...
              className={`flex items-center justify-center rounded-md border border-transparent bg-white px-4 
                py-1 text-xs font-medium text-indigo-600 shadow-sm hover:bg-indigo-50 focus:text-indigo-600`}
            ...
            <a
              ...
              className={`ml-2 flex items-center justify-center rounded-md border border-transparent bg-white 
                px-4 py-1 text-xs font-medium text-indigo-400 shadow-sm hover:bg-indigo-50 focus:text-indigo-600`}
              target='_blank' rel='noopener noreferrer'
            >
              Old v2 docs
            </a>

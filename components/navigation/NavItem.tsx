...
export default function NavItem({
  ...
  if (href && !hasDropdown) {
    return (
      <Link
        ...
        className={`${className} rounded-md font-body text-base font-semibold leading-6 text-gray-700 transition duration-150 ease-in-out hover:text-gray-900 focus:text-gray-900 focus:outline-none focus:ring-2 focus:ring-violet-500 ${
  ...
  const attrs = {
    onClick,
    onMouseEnter,
    className: `${className} rounded-md group inline-flex items-center space-x-2 font-body text-base leading-6 font-semibold hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:text-gray-900 tracking-heading transition ease-in-out duration-150`
  };

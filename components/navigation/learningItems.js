...
export default [
  ...
  { href: '/docs/tutorials/', icon: IconGradCap, className: 'bg-pink-200', title: 'Tutorials', description: 'Our Tutorials section teaches beginner processes with AsyncAPI by doing. ' },
  ...
  { href: '/docs/reference/specification/v2.3.0', icon: IconPaper, className: 'bg-yellow-200', title: 'Reference', description: `Our Reference section teaches how to set up your development environment, CLI, APIs, and beyond.` }
]

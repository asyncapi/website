...
export default [
  ...
  { href: '/docs/reference', icon: IconPaper, className: 'bg-yellow-200', title: 'Reference', description: `Our Reference section teaches how to set up your development environment, CLI, APIs, and beyond.` }
]

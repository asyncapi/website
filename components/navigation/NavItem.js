export default function NavItem ({
  ...
  if (href) {
    return (
      <a href={href} target={target} rel="noopener noreferrer nofollow" className={`${className} text-base leading-6 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150`}>
        {text}
      </a>
    )
  }

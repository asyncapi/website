    ...
    <>
      {
        items.map((item, index) => {
          ...
          return (
            ...
            >
              <div className={`flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-lg border ${item.className || ''} bg-secondary-100 border-gray-800 text-gray-900 sm:h-12 sm:w-12 ${item.comingSoon && 'opacity-50'}`}>

      ...
      <article className='h-full rounded-lg'>
          <Link href={post.slug} passHref>
            <a className={`h-full flex flex-col border border-gray-200 rounded-lg shadow-md divide-y divide-gray-200 transition-all duration-300 ease-in-out hover:shadow-lg overflow-hidden cursor-pointer`} data-testid="BlogPostItem-Link">
              ...
              <div className="dark:bg-slate-700 flex-1 bg-white p-6 flex flex-col justify-between">
                ...
                <div className="mt-6 flex items-center">
                  ...
                  <div className="ml-3">
                    <Heading level="h3" typeStyle="heading-xs-semibold" textColor="dark:text-white text-gray-900">
                    ...
                    <Paragraph typeStyle="body-sm" className="dark:text-gray-400 flex">

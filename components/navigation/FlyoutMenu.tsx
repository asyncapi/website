...
export default function Flyout({ items = [] }: FlyoutProps) {
  return (
    <div
      className='absolute z-50 -ml-4 md:h-[80vh] overflow-x-scroll w-screen max-w-md pt-3 md:ml-12 md:-translate-x-1/2 lg:left-1/2 lg:max-w-3xl lg:-translate-x-1/2 animate-in fade-in slide-in-from-top-3 duration-800 ease-out'

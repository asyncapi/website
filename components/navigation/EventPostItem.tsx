 ...
 *
 */
function EventPostItem({
  post,
  className = '',
  id,
}: EventPostItemProps): React.JSX.Element {
  ...
  const defaultCover =
    'https://github.com/asyncapi/community/assets/40604284/01c2b8de-fa5c-44dd-81a5-70cb96df4813';
  let active = true;
    ...
    <li key={id} className={className} data-testid="EventPostItem-main">
      <article className="h-full rounded-lg shadow-md hover:shadow-lg">
        ...
        >
          ...
          />
          <div
            className="mt-2 flex h-52 flex-col justify-between p-5 "
            data-testid="EventPostItem-post"
          >
            <div>

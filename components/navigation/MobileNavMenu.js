      ...
      <div className="rounded-lg shadow-lg">
        <div className="rounded-lg shadow-xs dark:bg-slate-800 bg-white divide-y-2 divide-gray-50 dark:divide-slate-700">
          ...
          <div className="py-2 px-5 space-y-2" onClick={() => showMenu('learning')} data-testid="MobileNav-docs">
            <h4 className="text-gray-800 dark:text-slate-400 font-medium flex justify-between"> <a className="cursor-pointer"><Link href="/docs" className="flex">Docs</Link></a><NavItemDropdown /></h4>
          ...
          <div className="py-2 px-5 space-y-2" onClick={() => showMenu('tooling')} data-testid="MobileNav-tools">
            <h4 className="text-gray-800 dark:text-slate-400 font-medium flex justify-between"> <a className="cursor-pointer"><Link href="/tools" className="flex">Tools</Link></a><NavItemDropdown /></h4>
          ...
          <div className="py-2 px-5 space-y-2" onClick={() => showMenu('community')} data-testid="MobileNav-community">
            <h4 className="text-gray-800 dark:text-slate-400 font-medium flex justify-between"><a className="cursor-pointer"><Link href="/community" className="flex">Community</Link></a><NavItemDropdown /></h4>
          ...
          <div className="py-2 px-5 space-y-2" onClick={() => showMenu('others')} data-testid="MobileNav-others">
            <div className="grid gap-4">
              <div>
                <h4 className="text-gray-800 dark:text-slate-400 font-medium mb-4 flex justify-between"><a className="cursor-pointer">Others</a><NavItemDropdown /></h4>

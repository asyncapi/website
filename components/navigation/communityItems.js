...
export default [
  ...
  { icon: IconDashboard, title: 'Dashboard',href: '/community/dashboard',target: '_blank', description: `Just need a good first issue to start your contribution journey? or want to see what topics are hot in discussion?`},

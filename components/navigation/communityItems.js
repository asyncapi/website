...
export default [
  ...
  { icon: IconTSC, title: 'Technical Steering Committee', href: '/community/tsc', description: 'Get to know what is a TSC member, how you can become one, and meet our current Ambassadors.' },
  { icon: IconTSC, title: 'Ambassadors', href: '/community/ambassador', description: 'Get to know what is AsyncAPI ambassador program, how you can become one, and meet our current TSC members.' },

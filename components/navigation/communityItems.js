...
export default [
  ...
  { icon: IconTSC, title: 'Ambassadors', href: '/community/ambassador', description: 'Get to know what is AsyncAPI ambassador program, how you can become one, and meet our current Ambassadors.' },

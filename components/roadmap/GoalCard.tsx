...
/**
 * @description GoalCard component that displays a goal in a styled card with a category badge.
 * @param {string} props.title - The title of the goal.
 * @param {React.ReactNode} props.description - The description of the goal.
 * @param {string} props.category - The category of the goal (default: 'GOAL').
 */

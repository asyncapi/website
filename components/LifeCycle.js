export default function LifeCycle({text, classname=''}) {
  ...
  if(text_type==="DEPRECATED") {Color="white", bgColor="lifecycle-deprecated"}
  else if(text_type==="REQUIRED") {Color="black", bgColor="lifecycle-required"}
  else if(text_type==="OPTIONAL") {Color="black", bgColor="lifecycle-optional"}

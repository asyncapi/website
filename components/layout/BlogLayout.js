      ...
      <Container cssBreakingPoint="lg" flex flexReverse>
        ...
        <main className="mt-8 px-4 sm:px-6 lg:pr-8 lg:pl-0 lg:flex-1 lg:max-w-172 xl:max-w-172">
          <header className="pr-4 sm:pr-6 md:pr-8">
            <h1
              className="dark:text-gray-500 text-4xl font-normal text-gray-800 font-sans antialiased"
            ...
            <div className="mt-6 flex items-center">
              ...
              <div className="ml-3">
                <p className="dark:text-gray-300 text-sm leading-5 font-medium text-gray-900">

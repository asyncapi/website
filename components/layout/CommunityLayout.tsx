...
interface ICommunityLayout {
  ...
  members?: Tsc[] | Ambassador[];
}

/**
 * @description This function returns the TSC or Board component.
 */
export default function CommunityLayout({ members, children, membership }: ICommunityLayout) {
  ...
  const relevantMembersList: Tsc[] | Ambassador[] = isTSCMembership ? TSCMembersList : members || [];

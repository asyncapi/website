...
export default function DocsLayout({ post, navItems = {}, children }) {
  ...
  return (
    <DocsContext.Provider value={{ post, navItems }}>
      ...
      <div className="bg-white dark:bg-slate-800 px-4 sm:px-6 lg:px-8 w-full xl:max-w-7xl xl:mx-auto">
        {showMenu && (
          <DocsMobileMenu
        ...
        <div className="flex flex-row" id="main-content">
          ...
          >
            <div className="flex flex-col w-72 border-r border-gray-200 dark:bg-slate-800 bg-white py-2">
              <div className="flex-1 flex flex-col md:overflow-y-auto md:sticky md:top-20 md:max-h-(screen-14)">
                ...
                <nav className="flex-1 dark:bg-slate-800 bg-white">
                  <ul>

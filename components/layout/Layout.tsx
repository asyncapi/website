...
export default function Layout({ children }: ILayoutProps): React.JSX.Element {
  ...
  if (pathname.startsWith('/docs')) {
    ...
    return (
      <div
        data-testid='Docs-main-container'
        className='bg-white dark:bg-slate-900 text-gray-900 dark:text-white min-h-screen'
      >
  ...
  if (pathname.startsWith('/blog/')) {
    ...
    return (
      <div
        data-testid='Blogs-main-container'
        className='bg-white dark:bg-slate-900 text-gray-900 dark:text-white min-h-screen'
      >
  ...
  if (pathname === '/blog') {
    return (
      <div
        data-testid='Blogs-sub-container'
        className='bg-white dark:bg-slate-900 text-gray-900 dark:text-white min-h-screen'
      >

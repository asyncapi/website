...
export function DocsCards() {
  return (
    <div className='grid gap-4 grid-cols-1 sm:grid-cols-2' data-testid="main-div">
...
function Card({ title, description, link, className, Icon }) {
  return (
    <Link href={link}>
      <a href={link} className='cursor-pointer' data-testid="link">
          ...
          <div data-testid="div-contents">
            ...
            >
              <div className='flex flex-row items-center'>
                <div className={`flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-lg ${className} text-gray-900 sm:h-12 sm:w-12`} data-testid="icon">

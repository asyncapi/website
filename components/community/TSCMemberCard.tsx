 ...
 * @returns {React.JSX.Element} GitHub icon component
 */
function GitHubIcon({ className = '' }: Readonly<{ className?: string }>): React.JSX.Element {
  return (
...
/**
 * @param {{ className?: string }} props - Props for the Twitter icon
 * @returns {React.JSX.Element} Twitter icon component
 */
function TwitterIcon({ className = '' }: Readonly<{ className?: string }>): React.JSX.Element {
  return (
    <svg className={className} fill='currentColor' viewBox='0 0 20 20'>
...
/**
 * @param {{ className?: string }} props - Props for the LinkedIn icon
 * @returns {React.JSX.Element} LinkedIn icon component
 */
function LinkedInIcon({ className = '' }: Readonly<{ className?: string }>): React.JSX.Element {
  return (
    <svg className={className} fill='currentColor' viewBox='0 0 19 19'>
      <path
        fillRule='evenodd'

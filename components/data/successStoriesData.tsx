...
export const successStories = [
  {
    ...
    description: (
      <DescriptionComponent>
        With the addition of a dedicated Community Manager, we now have a
        monthly newsletter, regular status updates, an active social media
        presence, and the ability to drive initiatives such as event
        organization. Dedicated focus enables us to also focus on{' '}
        <TextLink
  ...
  },
  {
    ...
    description: (
      <DescriptionComponent>
        The 2022 mentorship program yielded significant achievements: Kafka
        support in Glee, a centralized platform for sharing AsyncAPI tools, and
        a versatile error handling library for multiple projects.
      </DescriptionComponent>
    ),
  },
  {
    ...
    description: (
      <DescriptionComponent>
        Every year we organize a conference that attracts many participants. In
        2022 the online conference generated{' '}
        <TextLink

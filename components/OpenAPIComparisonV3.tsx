      ...
      <div className="mr-1 flex-1 border border-black p-2">
        ...
        <div>
          <div
            ...
            onMouseOver={() =>
              setHoverState((prevState) => ({ ...prevState, Info: true }))
            }
          ...
          <div className="flex flex-1 flex-wrap">
            <div
              ...
              onMouseOver={() =>
                setHoverState((prevState) => ({ ...prevState, Servers: true }))
              }
              onMouseLeave={() =>
                setHoverState({ ...hoverState, Servers: false })
              }
            >
              Servers
            </div>
          ...
          <div
            ...
            onMouseEnter={() =>
              setHoverState((prevState) => ({ ...prevState, Paths: true }))
            }
          ...
          >
            ...
            <div className="flex flex-1 flex-wrap">
              <div
                ...
                onMouseEnter={() => {
                  return setHoverState((prevState) => ({
                    ...prevState,
                    PathItem: true,
                  }));
                }}
                ...
                <div className="flex flex-1 flex-col flex-wrap">
                  ...
                  <div className="flex flex-1 flex-wrap">
                    <div
                      ...
                      onMouseLeave={() =>
                        setHoverState({ ...hoverState, OperationItem: false })
                      }
                    >
                      Operation
                      <div
                        ...
                        onMouseLeave={() =>
                          setHoverState({ ...hoverState, OperationType: false })
                        }
                      >
                        GET, PUT, POST, etc.
                      </div>
                      <div
                        ...
                        onMouseLeave={() =>
                          setHoverState({ ...hoverState, Message: false })
                        }
                      >
                        Request
                      </div>
          ...
          <div className="flex flex-1 flex-wrap">
            <div
              ...
              onMouseOver={() =>
                setHoverState((prevState) => ({ ...prevState, Tags: true }))
              }
              onMouseLeave={() =>
                setHoverState((prevState) => ({ ...prevState, Tags: false }))
              }
            >
              <p>Tags</p>
            </div>
            <div
              ...
              onMouseOver={() =>
                setHoverState((prevState) => ({ ...prevState, External: true }))
              }
              onMouseLeave={() =>
                setHoverState((prevState) => ({
                  ...prevState,
          ...
          <div
            ...
            onMouseOver={() =>
              setHoverState((prevState) => ({ ...prevState, Components: true }))
            }
            onMouseLeave={() =>
              setHoverState((prevState) => ({
                ...prevState,
      ...
      <div className="ml-1 flex-1 border border-black p-2">
        ...
        <div>
          <div
            ...
            onMouseLeave={() =>
              setHoverState((prevState) => ({ ...prevState, Info: false }))
            }
          >
            Info
          </div>
          <div className="flex flex-1 flex-wrap">
            <div
              ...
              onMouseLeave={() =>
                setHoverState((prevState) => ({ ...prevState, Servers: false }))
              }
            >
          ...
          <div
            ...
            onMouseLeave={() =>
              setHoverState((prevState) => ({ ...prevState, Paths: false }))
            }
          >
            Channels
            <div className="flex flex-1 flex-wrap">
          ...
          <div
            ...
            onMouseOver={() =>
              setHoverState((prevState) => ({ ...prevState, Operations: true }))
            }
            onMouseLeave={() =>
              setHoverState((prevState) => ({
                ...prevState,

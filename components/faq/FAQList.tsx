...
export const faqList: FAQ[] = [
  ...
  },
  {
    ...
    content: (
      <div>
        AsyncAPI is protocol - agnostic, so you can use it for APIs that work
        over any protocol(e.g., AMQP, MQTT, WebSockets, Kafka, STOMP, HTTP,
        Mercure, etc). For more information, refer to the{' '}
        <a
  ...
  },
  {
    ...
    content: (
      <div>
        <p>
          AsyncAPI users are those who implement and maintain event - driven
          architecture. For example, people that write backend API using
          WebSocket, or people that maintain communication between their
  ...
  },
  {
    ...
    content: (
      <div>
        It’s the core of the initiative. The AsyncAPI community contributes to
        the development of the tool, it promotes access and distribution of the
        specification allowing freedom of use, study, copying, modification, and
        redistribution to anyone who wishes to do so. The cooperation between
        these people in all areas of software production generates a substantial
        improvement in the quality of the software, as well as greater
        dissemination and sustainability over time, and prioritizing the benefit
        of society over any other.
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        Anyone. All projects under AsyncAPI Initiative are part of the Linux
        Foundation, licensed under the Apache 2.0 license. It’s open to use and
        contribution.
      </div>
    ),
  },

...
export const items: ISupportItemType[] = [
  {
    ...
    imgClass: 'inline-block px-4 sm:h-10 rounded-lg p-2 bg-white',
    section: 1
  },
  {
  ...
  },
  {
    ...
    imgClass: 'inline-block px-4 md:h-14 rounded-lg p-2 bg-white',
    section: 1
  },
  {
  ...
  },
  {
    ...
    imgClass: 'inline-block px-4 sm:h-10 md:h-10 lg:h-10 rounded-lg p-2 bg-white',
    section: 2
  },
  {

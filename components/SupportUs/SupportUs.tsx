      ...
      >
        {items
          ...
          .map((item, index) => (
            ...
            >
              <img className={`${item.imgClass} dark:bg-white/90 rounded-lg`}
               src={item.imgSrc}
              title={item.imgTitle}
               alt={item.imgTitle} />
            </a>
        ...
        {items
          ...
          .map((item, index) => (
            <a
              ...
              className='relative block w-2/3 p-4 text-center sm:w-1/3 sm:p-0 md:w-1/3 lg:w-1/5'
            >
              <img className={`${item.imgClass} dark:bg-white/90 rounded-lg`} src={item.imgSrc} title={item.imgTitle} alt={item.imgTitle} />
            </a>
          ))}
      </div>

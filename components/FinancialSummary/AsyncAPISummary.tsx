    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="mx-4 my-8 grid lg:grid-cols-9 lg:gap-8 lg:text-center">
        <div className="col-span-5 col-start-3">
          ...
          <Paragraph
            ...
            className="my-1 max-w-4xl text-darkGunMetal"
          >
            To help improve the current state of Event-Driven Architectures and
            their tooling, you can show your support for the AsyncAPI Initiative
            by making a financial contribution. We offer three donation options:{' '}
            <strong>
              Open Collective, GitHub Sponsors, and Linux Foundation
              Crowdfunding
            </strong>
            . Our expenses are managed through Open Collective and GitHub
            Sponsors, while Linux Foundation Crowdfunding operates separately.
          </Paragraph>
        </div>
      </div>
      ...
      <div className="max-width my-4 text-center text-base text-darkGunMetal">
        <Paragraph typeStyle={ParagraphTypeStyle.sm} className="my-4">
          The easiest way to support AsyncAPI is by becoming a financial
          sponsor. While <br className="hidden lg:inline-block" />
          there are alternative options, they may involve greater effort.
          Contribute <br className="hidden lg:inline-block" />

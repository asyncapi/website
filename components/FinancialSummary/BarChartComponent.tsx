...
export default function BarChartComponent() {
  ...
  const filteredData: ExpenseItem[] = Object.entries(ExpensesData).flatMap(
    ([month, entries]) =>
  ...
  const totalAmount: number = filteredData.reduce(
  ...
  const chartData: { Category: string; Amount: number }[] = Object.keys(
    categoryAmounts,
  ).map((category) => ({
    Category: category,
  ...
  const barWidth: number | undefined =
    windowWidth && windowWidth < 900 ? undefined : 800;
  const barHeight: number | undefined =
    windowWidth && windowWidth < 900 ? undefined : 400;
    ...
    <div className="mt-8 flex items-center justify-center sm:px-6 lg:px-8">
      <div className="w-full px-4 text-center lg:w-2/3">
        <div className="mb-5">
          ...
          <p>
            Gain insights into the allocation of funds across different
            categories through our Budget Analysis
          </p>
          <div className="my-4 flex flex-col justify-between md:m-8 md:flex-row md:items-center md:justify-between">
            <div className="my-2">
              ...
              <p className="mt-1 text-center text-xl font-semibold sm:text-left">
          ...
          <BarChart width={barWidth} height={barHeight} data={chartData}>
            ...
            <Bar
              ...
              onClick={(data) => {
                ...
                const matchedLinkObject: ExpensesLinkItem | undefined =
                  ExpensesLinkData.find((obj) => obj.category === category);

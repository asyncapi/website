...
export default function SuccessStories() {
    return (
        <div className="px-4 sm:px-6 lg:px-8 dark:bg-slate-700 bg-purple-100">
            <div className="grid lg:grid-cols-9 lg:gap-8 lg:text-center my-16">
                <div className="col-start-2 col-span-7 my-12">
                    ...
                    <p className="my-3 max-w-4xl mx-auto text-lg dark:text-gray-600 text-darkGunMetal text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                        <div className="m-4 p-2">
                            ...
                            <p className="text-base text-darkGunMetal dark:text-gray-600">

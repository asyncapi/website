      ...
      <div className="mb-16 grid lg:grid-cols-9 lg:gap-8 lg:text-center">
        <div className="col-span-7 col-start-2 my-12">
          <div className="mx-2">
            ...
            >
              Funds from GitHub Sponsors are directly transferred to our
              AsyncAPI Open Collective account. We maintain transparency in all
              expenses, and the TSC approves anticipated expenses.
            </Paragraph>
          </div>
                ...
                >
                  <div className="text-darkGunMetal">
                    <div className="flex flex-col items-center">
                      ...
                      />
                      <h2 className="my-2 text-center text-2xl font-semibold text-darkGunMetal">
                        {expense.title}
                      </h2>
                    </div>
                    <p className="text-center text-base text-darkGunMetal">
                      {expense.description}
                    </p>
                  </div>
                </a>

        ...
        <div className="col-span-7 col-start-2 my-12">
          <div className="mx-2">
            ...
            >
              ...
              <br className="hidden lg:inline-block"></br> involved through
              employment, providing services and
          ...
          <div className="mx-3 mt-8 grid grid-cols-1 gap-10 md:grid-cols-3">
            {otherFormsData.map((form, index) => (
              <div
                key={index}
                className="flex flex-col items-center rounded-md bg-white p-4 text-center shadow-md"
              >
                <img
                  src={form.imageUrl}
                  alt={form.title}
                  className="m-2 h-auto w-1/3 object-cover"
                />

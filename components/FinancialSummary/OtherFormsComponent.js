...
export default function OtherFormsComponent() {
    return (
        <div className="dark:bg-slate-800 px-4 sm:px-6 lg:px-8 bg-[#F5F5F5]">
            <div className="grid lg:grid-cols-9 lg:gap-8 lg:text-center">
                <div className="col-start-2 col-span-7 my-12">
                    <div className="mx-2">
                        ...
                        <Paragraph typeStyle="body-md" className="dark:text-gray-400 mb-3 max-w-4xl mx-auto text-center text-darkGunMetal">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-8 mx-3">
                        <div className="dark:bg-slate-700 bg-white rounded-md shadow-md p-4 flex flex-col items-center text-center">
                            ...
                            <p className="dark:text-gray-600 text-base text-darkGunMetal mt-1 mx-2">

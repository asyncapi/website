...
export default function Features() {
  ...
  return (
    <section className="dark:bg-slate-800 relative bg-white pt-16">
        ...
        <div className="mt-12 text-left">
          <ul className="grid  grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3" data-testid="Feature-ul">
            {features.map((feature) => (
              <li key={feature.id} className="dark:border-slate-700 flex flex-col justify-between border border-gray-200 shadow-md hover:shadow-lg transition-all duration-300 ease-in-out rounded-lg px-6 pb-8" data-testid="Feature-li">
                <div>

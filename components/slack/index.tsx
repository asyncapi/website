...
export default function Slack({ className = '' }: SlackProps) {
  return (
    <div
      className={`flex overflow-hidden rounded-md border border-gray-200 bg-white ${className}`}
    >
      ...
      <div className="flex-1 py-2" data-testid="SlackMessage">
        <SlackMessage
          ...
          text={
            <>
              ...
              <img
                ...
                src="/img/homepage/grain.png"
                alt="grain"
              />
              <img
                className="ml-1 inline-block size-5"
                src="/img/homepage/coffee.png"
                alt="coffee"
              />
            </>
          }
          reactions={[
            {
              icon: '/img/homepage/coffee.png',
              name: 'coffee',
              count: 6,
              mine: true,
            },
            {
              icon: '/img/homepage/coffee-parrot.gif',
              name: 'coffee-parrot',
              count: 4,
              mine: true,
            },
            {
              icon: '/img/homepage/coffee-bean.png',
              name: 'coffee-bean',
              count: 6,
              mine: true,
            },
            {
              icon: '/img/homepage/parrotsleep.gif',
              name: 'parrotsleep',
              count: 1,
              mine: false,
            },

    ...
    <div className='relative inline-block'>
      <div className='relative flex items-center gap-2'>
        ...
        <select
          ...
          className={twMerge(
            'form-select h-full px-10 pr-7 inline-flex justify-center rounded-md border border-gray-300 shadow-sm py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:border-gray-500 focus:outline-none focus:ring-0 focus:ring-black',
            className
          )}
          value={selected}
        >

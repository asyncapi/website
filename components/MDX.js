...
export function getMDXComponents() {
  return {
    h1: props => <h1 {...props} className={`${props.className || ''} dark:text-gray-600 my-4 font-heading antialiased font-semibold tracking-heading text-gray-900 text-2xl`} />,
    h2: props => <h2 {...props} className={`${props.className || ''} dark:text-gray-600 mb-4 mt-6 font-heading antialiased font-semibold tracking-heading text-gray-900 text-2xl`} />,
    h3: props => <h3 {...props} className={`${props.className || ''} dark:text-gray-600 mb-4 mt-6 font-heading antialiased font-medium tracking-heading text-gray-900 text-lg`} />,
    h4: props => <h4 {...props} className={`${props.className || ''} dark:text-gray-600 my-4 font-heading antialiased font-medium text-md text-gray-900`} />,
    h5: props => <h5 {...props} className={`${props.className || ''} dark:text-gray-600 my-4 font-heading antialiased text-md font-bold`} />,
    h6: props => <h6 {...props} className={`${props.className || ''} dark:text-gray-600 my-4 font-heading antialiased text-sm font-bold text-gray-900 uppercase`} />,
    ...
    strong: props => <strong {...props} className={`${props.className || ''} dark:text-gray-400 my-4 text-gray-800 font-semibold font-body antialiased`} />,

  ...
  return {
    ...
    h4: (props) => (
      <h4
        ...
        className={`${
          props.className || ''
        } my-4 font-heading antialiased font-medium text-md text-gray-900`}
      />
    ),
    h5: (props) => (
      <h5
    ...
    th: (props) => (
      <th
        ...
        className={`${
          props.className || ''
        } px-6 py-3 border-b border-gray-200 bg-gray-100 text-left text-xs leading-4 font-medium font-body text-gray-900 uppercase tracking-wider`}
      />
    ),
    tr: (props) => (
    ...
    td: (props) => (
      <td
        ...
        className={`${
          props.className || ''
        } px-6 py-4 border-b border-gray-200 text-sm leading-5 text-gray-700 tracking-tight`}
      />
    ),
    pre: (props) => (
    ...
    inlineCode: (props) => (
      <code
        ...
        className={`${
          props.className || ''
        } px-1 py-0.5 bg-gray-200 text-gray-800 rounded font-mono text-sm`}
      />
    ),
    details: (props) => (
      <details
        ...
        className={`${
          props.className || ''
        } mb-1 font-heading antialiased font-medium text-gray-900`}
      />
    ),
    summary: (props) => (
      <summary
        ...
        className={`${
          props.className || ''
        } my-2 font-heading antialiased font-semibold text-gray-900`}
      />
    ),
    code: CodeComponent,
    hr: (props) => (
...
function MermaidDiagram({ graph }) {
  ...
  useLayoutEffect(() => {
    ...
    try {
      mermaid.mermaidAPI.render(uuid(), graph, (renderedSvg) =>
        setSvg(renderedSvg)
      );
    } catch (e) {
      setHtml(null);

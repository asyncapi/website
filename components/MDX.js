...
export function getMDXComponents() {
  return {
    h1: props => <h1 {...props} className={`${props.className || ''} my-4 font-heading dark:text-gray-600 antialiased font-semibold tracking-heading text-gray-900 text-2xl`} />,
    h2: props => <h2 {...props} className={`${props.className || ''} mb-4 mt-6 font-heading dark:text-gray-600 antialiased font-semibold tracking-heading text-gray-900 text-2xl`} />,
    h3: props => <h3 {...props} className={`${props.className || ''} mb-4 mt-6 font-heading antialiased dark:text-gray-600 font-medium tracking-heading text-gray-900 text-lg`} />,
    h4: props => <h4 {...props} className={`${props.className || ''} my-4 font-heading antialiased font-medium text-md dark:text-gray-600 text-gray-900`} />,
    h5: props => <h5 {...props} className={`${props.className || ''} my-4 font-heading dark:text-gray-600 antialiased text-md font-bold`} />,
    h6: props => <h6 {...props} className={`${props.className || ''} my-4 font-heading dark:text-gray-600 antialiased text-sm font-bold text-gray-900 uppercase`} />,
    ...
    p: props => <p {...props} className={`${props.className || ''} dark:text-gray-600 my-4 text-gray-700 font-regular font-body antialiased`} />,
    strong: props => <strong {...props} className={`${props.className || ''} my-4 dark:text-gray-400 text-gray-800 font-semibold font-body antialiased`} />,
    a: props => <a {...props} className={`${props.className ? props.className : 'dark:text-gray-500 text-gray-900 font-semibold border-b border-secondary-400 hover:border-secondary-500 transition ease-in-out duration-300'} font-body antialiased`} />,

...
export default function CategoryDropdown({ setopenCategory }) {
  ...
  return (
    <div className="dark:bg-slate-700 absolute z-10 w-52 lg:w-56 origin-top-right h-60 overflow-y-auto rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button"

...
export default function ToolsCard({ toolData }) {
  ...
  return (
    <div className="border dark:bg-gray-900 shadow-md h-auto flex flex-col rounded-lg">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className='relative'>
            <Paragraph typeStyle="body-sm">
              <div ref={descriptionRef} className={`w-full dark:text-gray-600 ${showMoreDescription ? 'cursor-pointer' : ''}`} onMouseEnter={() => (setTimeout(() => { if (showMoreDescription) setShowDescription(true) }, 500))}>
                <TextTruncate
                  element="span"
                  line={3}
      ...
      {(toolData.links.repoUrl || toolData.links.websiteUrl || toolData.links.docsUrl) && <>
        ...
        <div className="flex">
          {toolData.links.repoUrl && <>
            {onGit ?
              <a className="w-full text-center border-x py-6 px-1 dark:hover:bg-gray-700 hover:bg-gray-200 cursor-pointer" href={toolData.links.repoUrl} target='_blank' rel='noreferrer' data-testid="ToolsCard-repoUrl">
                <div className="m-auto flex w-fit gap-2">
                  <img src="/img/logos/github-black.svg" className="w-5" />
                  <div className="text-gray-700 dark:text-gray-500 text-sm">View Github</div>
                </div>
              </a> :
              <a className="w-full text-center border-x border-gray-200 py-6 px-1 dark:hover:bg-gray-700 hover:bg-gray-200 cursor-pointer" href={toolData.links.repoUrl} target='_blank' rel='noreferrer'>
                <div className="m-auto flex w-fit gap-2">
                  <div className="text-gray-700 dark:text-gray-500 text-sm">View Source Code</div>
                </div>
              </a>
            }
          </>}
          {toolData.links.websiteUrl && (
            <a className="w-full text-center py-6 px-1 dark:hover:bg-gray-700 hover:bg-gray-200 border-x border-gray-200 cursor-pointer" href={toolData.links.websiteUrl} target='_blank' rel='noreferrer' data-testid="ToolsCard-websiteUrl">
              <div className="m-auto flex w-fit gap-2">
                <img src="/img/illustrations/icons/share.svg" className="w-5" />
                <div className="text-gray-700 dark:text-gray-500 text-sm">Visit Website</div>
              </div>
            </a>
          )}
          {toolData.links.docsUrl && (
            <a className="w-full text-center py-6 px-1 dark:hover:bg-gray-700 hover:bg-gray-200 border-x border-gray-200 cursor-pointer" href={toolData.links.docsUrl} target='_blank' rel='noreferrer' data-testid="ToolsCard-docsUrl">
              <div className="m-auto flex w-fit gap-2">
                <img src="/img/illustrations/icons/docs-icon.svg" className="w-5" />
                <div className="text-gray-700 dark:text-gray-500 text-sm">Visit Docs</div>
              </div>
            </a>
          )}
        </div>

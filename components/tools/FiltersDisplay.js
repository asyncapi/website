...
export default function FiltersDisplay({ checkedDomain = [], setDomain }) {
      ...
      {checkedDomain.map((items, index) => {
        return (
          ...
          >
            ...
            <button className="hover:bg-gray-100 p-1 rounded-full -mt-[2px]" onClick={(e) => handleClickOption(e, items, checkedDomain, setDomain)}>

    ...
    <div className="sm:flex sm:justify-between" id="main-content">
      <div className="lg:flex lg:justify-between">
        <div className="max-w-xl">
          <h2 className="text-4xl leading-10 font-extrabold dark:text-white text-gray-900 sm:text-4xl sm:leading-none sm:tracking-tight" data-testid="Header-heading">
            Dashboard
          </h2>
          <p className="mt-5 text-xl leading-7 dark:text-gray-500 text-gray-700" data-testid="Header-paragraph">

              ...
              <div className='flex items-center justify-between px-4 sm:px-5 py-3 sm:py-4 bg-gradient-to-r from-gray-50 to-white dark:from-dark-background dark:to-dark-card border-b border-gray-200 dark:border-gray-700'>
                <div className='flex items-center gap-2'>
                  <div className='w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-primary-100 dark:bg-primary-900/30 flex items-center justify-center flex-shrink-0'>
                    <svg className='w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-600 dark:text-primary-400' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
                ...
                >
                  <img src='/img/illustrations/icons/close-icon.svg' alt='close' className='w-4 h-4 dark:invert dark:opacity-80' />
                </button>
              </div>
              <div className='flex flex-col gap-4 p-4 sm:p-5'>
                <div>
                  <h5 className='text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-3'>BY REPOSITORY</h5>
                  <Select
                    options={uniqueRepos}
                ...
                <div>
                  <h5 className='text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-3'>BY AREA</h5>

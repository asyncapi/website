...
export default function Table({
  ...
  return (
    <div
      className={`rounded border border-gray-200  bg-gray-50 lg:w-1/2 ${className}`}
    >
      ...
      <div className="min-w-full inline-block overflow-y-scroll">
        {data.length === 0 && (
          <div className="w-full p-5 text-base font-medium">
            <p>
              There aren&apos;t any good first issues open for the given
              repository and area at the moment.
            </p>
            <ul className="mt-3 list-disc pl-5 text-sm font-[400]">
              ...
              <li className="mb-2">
                ...
                channel, call out the maintainers that you want to work with.
                Ask them if there are any issues you could solve. You know who
                these people are from{' '}
                <span className="font-bold">CODEOWNERS</span> file in each repo.
              </li>
              <li className="mb-2">
                If there is no response, you need to look for a different issue

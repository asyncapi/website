  ...
  return (
    ...
    >
      ...
      <div className="inline-block min-w-full overflow-y-scroll">
        {data.length===0 && <p className='font-medium text-base w-full p-5'>There aren't any good first issues open for the given repository and area at the moment. Please check after sometime.</p>}

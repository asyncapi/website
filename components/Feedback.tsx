...
export default function Feedback({ className }: IFeedbackProps) {
  ...
  if (submitted) {
    return (
      <div
        className={`flex flex-col rounded-md border border-gray-200 p-4 text-center shadow-md ${className}`}
      >
        <div className="mx-auto block w-fit">
          <img
            src="/img/illustrations/icons/icon-check.svg"
            className="md:w-14"
            alt="checkmark"
            aria-hidden="true"
          />
        ...
        <div
          className="mx-auto mt-4 text-center text-lg"
          data-testid="Feedback-div"
        >
  ...
  if (error) {
    return (
      ...
      >
        <div className="mx-auto block w-fit">
          <img
            src="/img/illustrations/icons/icon-x.svg"
            className="md:w-14"
            alt="x"
            aria-hidden="true"
          />
  ...
  return (
    <div
      className={`flex flex-col rounded-md border border-gray-200 p-4 shadow-md ${className}`}
    >
      <div className="flex flex-row">
        <img
          src="/img/illustrations/icons/icon.svg"
          className="my-auto sm:size-14 lg:w-16"
          alt=""
          aria-hidden="true"
        />
      ...
      <form onSubmit={handleSubmit}>
        <div className="my-4 flex flex-col">
          ...
          <div className="mt-4 block text-sm lg:flex lg:flex-row">
            ...
            <div className="my-2 w-full text-center font-medium lg:my-auto lg:w-1/12">
              OR
            </div>
            <GitHubIssue />
          </div>

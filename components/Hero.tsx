    ...
    <>
      ...
      <header className={`mt-12 px-2 ${className}`}>
        <div className="text-center">
          ...
          >
            {t('main.header')}{' '}
            <span className="block md:-mt-4"> {t('main.subHeader')}</span>
          </Heading>
          <Heading
          ...
          <div className="flex flex-col items-center justify-center gap-2 md:flex-row">
            ...
            <AlgoliaSearch>
              <SearchButton className="flex w-full items-center space-x-3 rounded-md border border-secondary-500 dark:border-dark-purple-500 bg-secondary-100 dark:bg-dark-purple-800 px-4 py-3 text-left text-secondary-500 dark:text-white shadow-md transition-all duration-500 ease-in-out hover:bg-secondary-500 dark:hover:bg-dark-purple-600 hover:text-white md:w-auto">
                {({ actionKey }) => (
                  <>
                    <IconLoupe />

...
function ScrollButton() {
  ...
  return (
    <div className='fixed bottom-14 right-4 z-40 h-16 w-12'>
      {backToTopButton && (
        <button
          className='rounded-full bg-white dark:bg-dark-purple-800 shadow-md transition-all duration-300 ease-in-out hover:scale-110 hover:bg-[#8851FB] dark:hover:bg-dark-purple-600'
          onClick={scrollUp}
        >

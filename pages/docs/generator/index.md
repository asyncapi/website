...
To specify what exactly must be generated you create a so called **template**. To create your own template, check out [How to create a template](#how-to-create-a-template).

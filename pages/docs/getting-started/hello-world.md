...
<CodeBlock language="yaml" className="h-56">
{`asyncapi: 2.0.0
info:
...
<CodeBlock className="h-56" highlightedLines={[1]}>
{`asyncapi: 2.0.0
info:
  title: Hello world application
  version: '0.1.0'
...
<CodeBlock className="h-56" highlightedLines={[2,3,4]}>
{`asyncapi: 2.0.0
info:
  title: Hello world application
  version: '0.1.0'
...
<CodeBlock className="h-56" highlightedLines={[5,6,7,8,9,10,11]}>
{`asyncapi: 2.0.0
info:
  title: Hello world application
  version: '0.1.0'
...
<CodeBlock className="h-56" highlightedLines={[6,7,8,9]}>
{`asyncapi: 2.0.0
info:
  title: Hello world application
  version: '0.1.0'
...
<CodeBlock className="h-56" highlightedLines={[9,10,11]}>
{`asyncapi: 2.0.0
info:
  title: Hello world application
  version: '0.1.0'

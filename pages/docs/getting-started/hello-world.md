...
Let's define an application that's capable of receiving a "hello {name}" message, that is, clients can publish to `hello` channel, and the `Hello world application` will receive the message.

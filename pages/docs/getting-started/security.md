...
There are many more security schemes. Learn more about them <Link href="/docs/specifications/2.2.0/#securitySchemeObject"><a className="text-teal-600 font-medium hover:underline cursor-pointer">here</a></Link>.

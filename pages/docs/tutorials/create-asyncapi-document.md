...
[MQTT](https://mqtt.org/) is a very well-known protocol that is widely used in IoT applications because it was particularly created to address machine-to-machine (M2M) communication.

    ...
    <GenericLayout title='AsyncAPI Ambassador Program' description='The AsyncAPI Ambassador Program' image={image} wide>
      ...
      <div className='bg-white dark:bg-dark-background py-12 sm:py-16 lg:py-20'>
        <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-8'>
            <span className='inline-block rounded-full bg-primary-100 dark:bg-primary-900/30 px-4 py-2 text-sm font-semibold text-primary-600 dark:text-primary-400 mb-6'>
              Community
            </span>
            <h1
              className='text-4xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-5xl lg:text-6xl mb-6'
            ...
            <div className='mt-10' data-testid='Ambassadors-button'>
              <Button
                className='inline-block text-center hover:bg-primary-600 focus:outline-none'
            ...
            {ambassadorList.tokens.map((token, index) => (
              ...
              >
                <div className='rounded-full bg-secondary-100 dark:bg-secondary-900/30 p-4 mb-6'>
                  <div className='h-16 w-16 flex items-center justify-center text-5xl'>
                    {token.emoji}
                  </div>
                </div>
                <Heading
      ...
      >
        <div className='relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            The AsyncAPI Ambassador program is now open for applications! If you're selected, you'll join AsyncAPI's
            mission of helping community members all over the world, build the future of Event-Driven APIs.
          </Heading>

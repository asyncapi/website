  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1
            className='mt-10  text-3xl font-semibold md:text-4xl lg:text-5xl'
          ...
          >
            ...
            Become an AsyncAPI Ambassador and help
            the OSS community build the
            future of APIs.
          </Heading>
        ...
        <div className='flex justify-center'>
          ...
          >
            ...
            >
              ...
              share their interest, expertise, and
              excitement within their
            ...
            >
              <div>
                <div
                  ...
                  data-testid='Ambassadors-members-details'
                >
                  <div>{ambassador.name}</div>
                  <div data-testid='Ambassadors-members-country'>
                    {ambassador.country}
                  </div>
                </div>
                <Link
              ...
              <div className='flex h-full flex-col justify-between'>
                ...
                <div
                  ...
                  data-testid='Ambassadors-members-socials'
                >
                  <a
        ...
        <div className='flex justify-center'>
          ...
          >
            ...
            >
              ...
              knowledge with your communities. Let us support
              you!
            </Heading>
          </div>
        </div>
        <div className='mt-10'>
          <ul className='grid grid-cols-1 gap-5 sm:grid-cols-3 lg:grid-cols-4'>
            {ambassadorList.tokens.map((token) => (
              <li
                key={token.title}
                className='mt-4 flex rounded-lg bg-white p-3 shadow-lg'
              >
                <div>
                ...
                <div className='ml-[10px]'>
                  <Heading typeStyle={HeadingTypeStyle.xs}>
                    {token.title}
                  </Heading>
                  <p className='mt-[5px] text-xs text-slate-600'>
                    {token.details}
                  </p>
                </div>
              </li>
          ...
          <div className='flex justify-center'>
            <div className='p-4 text-center text-white lg:w-[65%]'>
              ...
              <Heading typeStyle={HeadingTypeStyle.bodyLg}>
                ...
                you&apos;re selected, you&apos;ll join
                AsyncAPI&apos;s mission
                of helping community members all over the world, build the

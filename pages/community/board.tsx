  ...
  return (
    <CommunityLayout membership={Membership.BOARD}>
      <div className='mx-auto my-0 grid max-w-xl lg:max-w-screen-xl lg:grid-cols-3 lg:gap-8' data-testid='GB-content'>
        <div>
          <h3 className='text-primary-800 dark:text-white mb-2 font-semibold lg:text-center lg:text-2xl'>
        ...
        <div>
          ...
          <p className='my-4 text-base text-gray-500 dark:text-gray-400 lg:text-center'>
            ...
            <TextLink
              ...
              target='_blank'
              className='font-normal text-base text-blue-500 dark:text-blue-400 no-underline hover:text-sky-400 dark:hover:text-sky-300'
            >
              governance file
            </TextLink>
            .

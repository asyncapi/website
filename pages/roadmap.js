      ...
      <div className="py-12 overflow-hidden">
        <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-screen-xl">
          <div className="relative">
            ...
            <p className="mt-12 mb-4 mx-auto text-center text-gray-800 lg:w-1/2">
            ...
            <p className="text-xs text-center text-gray-600 mt-8">
              <strong>Attention:</strong> this road map is synchronized with the Github issues in the <a href="https://github.com/asyncapi/shape-up-process/issues?q=is%3Aopen+is%3Aissue+label%3AOutcome" target="_blank" rel="noopener noreferrer nofollow" className="underline hover:text-gray-900">asyncapi/shape-up-process</a> repository.
            </p>
          </div>
        </div>
      </div>

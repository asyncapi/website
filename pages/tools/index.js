        ...
        <Container wide>
          ...
          <div className="flex flex-row gap-5 my-10">
            <div className='relative w-1/12 h-auto'>
              <div className="flex py-2 justify-center items-center gap-2 rounded-lg border w-full h-full border-gray-300 hover:bg-gray-300 text-gray-700 shadow text-sm cursor-pointer" onClick={() =>  setFilter(!showFilter)}>
                <FilterIcon />
                <div>Filter</div>
              </div>
              {showFilter && <div className='z-10 absolute top-14 min-w-[20rem]'>
                <Filters />
              </div>}
            </div>
            <div className="py-1 px-4 flex justify-between gap-2 rounded-lg border w-3/12 border-gray-300 hover:bg-gray-300 text-gray-700 shadow text-sm cursor-pointer">
              <div><div className="relative top-1/2 -translate-y-1/2">Jump to Category</div></div>
            ...
            <div className="py-1 px-4 flex rounded-lg border w-8/12 border-gray-300 hover:border-gray-600 focus:border-gray-600 text-gray-700 shadow text-sm">
              ...
              <input className="border-none outline-none flex-1 focus:ring-0" placeholder="Search by name" type="text" />
            </div>
          </div>
          <div className="mt-10">
            <ToolsList />

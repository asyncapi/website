...
Do we regret we engaged with event participants? Hell no! So far, yes, we got only 2 SPAM PRs, but we also got many issues addressed (25 in 7 days) that we listed for the event. 
